...
const images = [
  "/Images/People/Class12Result1.jpg",
  "/Images/People/Class12Result2.jpg",
]

const ClassXIIToppers: React.FC = () => {
  ...
  return (
    <>
      {/* Image Grid */}
      <div className="max-w-7xl mx-auto px-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
        {images.map((src, idx) => (
          <div
            key={idx}
...
export default ClassXIIToppers