    ...
    <section className="relative py-25 bg-white overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="text-left">
          <span className="text-amber-500 font-outfit font-semibold uppercase tracking-wide text-sm mb-3 block">
            Our Secondary School Philosophy
          </span>

          <h2 className="text-3xl sm:text-4xl lg:text-4xl font-raleway font-extrabold text-gray-900 leading-tight mb-5">
            Where learning gains<br /> direction and depth
          </h2>

          <p className="text-lg text-gray-700 mb-4">
            In the Secondary Wing, students are guided to refine their interests, sharpen their skills, and take ownership of their learning journey. Academic rigor is balanced with mentorship, creative expression, and community engagement.
          </p>

          <p className="text-lg text-gray-700 mb-6">
            At this stage, we help students apply knowledge meaningfully — developing analytical thinking, emotional maturity, and leadership qualities. Every experience prepares them to face challenges with purpose and perseverance.
          </p>
        </div>
