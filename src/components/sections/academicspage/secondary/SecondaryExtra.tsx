...
const ENRICHMENTS = [
  ...
  {
    id: 4,
    title: "Editorial & Debate Society",
    description:
      "Young voices learn to articulate, persuade, and express ideas with clarity and conviction.",
    image: "",
    bg: "bg-lime-200",
  },
  {
  ...
  },
  {
    ...
    description:
      "Sportsmanship and teamwork take center stage — promoting discipline, health, and determination.",
    image: "",
    bg: "bg-rose-300",
  },
];
