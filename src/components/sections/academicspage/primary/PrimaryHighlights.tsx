  ...
  return (
    ...
    >
      <img
        ...
        className="absolute w-auto h-full top-[0px] pointer-events-none select-none"
      />
      <img
        src="/Images/Academics/PRhighlights.png"
        alt="Cute monkey illustration"
        className="absolute w-auto h-full top-[0px] right-[0px] pointer-events-none select-none"
      /> 
