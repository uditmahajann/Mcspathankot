  ...
  return (
    ...
    >
      <img
        ...
        className="absolute bottom-[-72px] right-[100px] w-[360px] pointer-events-none select-none z-20"
      />
      <img
        src="/Images/Academics/SLhighlights.png"
        alt="Cute monkey illustration"
        className="absolute bottom-[-80px] left-[60px] w-[360px] pointer-events-none select-none z-20"
      />
       
