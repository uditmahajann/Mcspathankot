  ...
  return (
    <section className="relative text-white">
      <div
        ...
        style={{
          backgroundImage: `url('/Images/About/Gate.JPG')`,
        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Contact Us</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Connect with <span className="text-blue-400"> MCS </span><br className="hidden sm:block" />
                Office
              </h1>
...
//                   Connect <span className="text-blue-300">with MCS Office</span>
//                 </h1>
