...
const tournaments = [
  {
    title: "Annual Theatre Showcase: Stories in Motion",
    result: "Best Group Performance Award",
    detail: "2024 • City Level",
    img: "/Images/Campus/NewHostel.JPG",
  },
  {
    title: "District Cultural Dance Festiva",
    result: "Best Group Performance Award",
    detail: "Track & Field • Sprint + Relay",
    img: "/Images/Campus/NewHostel.JPG",
  },
  {
    title: "Inter-School Music Concert",
    result: "Best Group Performance Award",
    ...
    <section className="w-full py-20 md:py-25 bg-[#0B0B0B] text-white">
      ...
      <div className="text-center mb-16 px-6">
        ...
        <p className="mt-5 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Where practice became performance — and creativity became celebration.
        </p>
      </div>
        ...
        {tournaments.map((t, i) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col gap-2">
              ...
              <span className="mt-3 inline-block bg-purple-400 text-black px-5 py-2 rounded-full font-inter font-semibold text-sm w-fit">
                {t.result}
              </span>
            </div>
          </div>
