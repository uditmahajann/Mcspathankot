        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Vision and Mission</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Discover our <span className="text-amber-300">Guiding</span><br className="hidden sm:block" />
                Principles
              </h1>
...
//               Discover <span className="text-blue-300">Our Guiding Principles</span>
//             </h1>
