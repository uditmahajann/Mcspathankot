  ...
  return (
    <section className="relative text-white">
      <div
        ...
        style={{
          backgroundImage: `url('/Images/About/Cbse.jpg')`,
        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Affiliated to CBSE</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Our <span className="text-cyan-400">Mandatory</span><br className="hidden sm:block" />
                Public Disclosure
              </h1>
...
//         {/* Content */}
//         <div className="relative mx-auto px-5 min-[480px]:px-12 sm:px-10 py-10 sm:py-16 md:py-18 z-10">
...
//               Our <span className="text-blue-300">Mandatory Public Disclosure</span>
//             </h1>
