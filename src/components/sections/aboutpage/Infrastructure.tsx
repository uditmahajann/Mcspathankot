...
const Infrastructure: React.FC = () => {
  ...
  return (
    <section id="our-infrastructure" className="pb-10 sm:pb-16 py-10 my-10 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Banner Image */}
        <div className="relative overflow-hidden rounded-2xl mb-20 shadow-2xl">
          <img
            src="/Images/Campus/ModernInfra.JPG"
            alt="MCS Campus Overview"
            className="h-120 w-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-blue-900/1 to-transparent"></div>
          <div className="absolute bottom-0 left-0 p-8">
            <h3 className="text-3xl font-bold text-white">Modern Campus</h3>
...
//             <h3 className="text-3xl font-bold text-white">Modern Campus</h3>
//             <p className="mt-2 max-w-2xl text-blue-100">
//               Our sprawling campus features modern architecture, green spaces, and purpose-built facilities designed to
//               create an optimal learning environment away from the dins of the city.
//             </p>
//           </div>
//         </div>
...
//               <div
//                 key={index}
//                 className="rounded-xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group cursor-pointer"
//               >
//                 <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
//                   {IconComponent && <IconComponent className="h-6 w-6" />}
//                 </div>
...
//       <a
//         key={index}
//         href={`/facilities/${facility.name.replace(/\s+/g, "-").toLowerCase()}`}
//         className="rounded-xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group cursor-pointer block"
//       >
//         <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
//           {IconComponent && <IconComponent className="h-6 w-6" />}
...
//         {/* CTA Button */}
//         <div className="mt-16 text-center">
//           <CtaButton text="Take a Virtal Tour" href="/preview" icon={Video} />
//         </div>
//       </div>
//     </section>
//   );
