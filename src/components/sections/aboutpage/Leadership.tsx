...
const Leadership: React.FC = () => {
  ...
  const leaders = [
    ...
    },
    {
      ...
      image: "/Images/People/Rashmi.jpg",
  ...
  return (
    <section id="our-leadership" className="pb-10 sm:pb-16 py-10 my-10 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 bg-blue-50 p-12 rounded-2xl shadow-sm font-inter text-lg">
          ...
          {leaders.map((leader, index) => (
            <div
              ...
              className={`flex flex-col ${index % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"
                } gap-8 items-center bg-white rounded-2xl shadow-xl p-12 transition-all duration-300 hover:shadow-2xl`}
            >
              <div className="md:w-1/3 flex justify-center">
                <div className="relative">
                  <div className="absolute inset-0 rounded-full bg-blue-600 opacity-10 transform scale-110 animate-pulse"></div>
                  <div className="relative h-72 w-72 overflow-hidden rounded-full border-4 border-blue-600 z-10">
                    <img
              ...
              <div className="md:w-2/3">
                <h3 className="text-2xl font-poppins font-bold text-gray-900 mb-2">{leader.name}</h3>
                <p className="text-xl text-primary font-inter font-semibold mb-4">{leader.position}</p>
                <p className="text-gray-700 font-inter text-lg">{leader.bio}</p>
              </div>
            </div>
          ))}
        </div>
