  ...
  return (
    <section className="relative text-white">
      <div
        ...
        style={{
          backgroundImage: `url('/Images/About/Infra.JPG')`,
        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Our Infrastructure</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                A <span className="text-emerald-400">Campus </span>Built for<br className="hidden sm:block" />
                Excellence
              </h1>
...
//               A Campus <span className="text-blue-300">Built for Excellence</span>
//             </h1>
