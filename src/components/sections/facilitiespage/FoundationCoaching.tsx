...
const FoundationCoaching = () => {
  return (
    <section id="foundation-coaching" className="pb-10 sm:pb-16 py-10 my-10 bg-white">
        ...
        <div className="flex flex-col md:flex-row gap-20">
          ...
          <div className="md:w-1/2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-emerald-50 p-4 rounded-lg">
                <Target className="w-6 h-6 text-emerald-500 flex-shrink-0 mb-2" />
              ...
              <div className="bg-rose-50 p-4 rounded-lg">
                <Brain className="w-6 h-6 text-rose-500 flex-shrink-0 mb-2" />
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                <Lightbulb className="w-6 h-6 text-yellow-500 flex-shrink-0 mb-2" />
              ...
              <div className="bg-purple-100/60 p-4 rounded-lg">
                <Search className="w-6 h-6 text-purple-500 flex-shrink-0 mb-2" />
          ...
          <div className="md:w-1/2 sticky top-40 max-h-fit">
            <div className="relative">
              ...
              />
              {/* <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primarydark/80 text-white p-4 md:p-6 rounded-lg backdrop-blur-sm z-20 w-4/5 md:w-2/3 text-center">
                <BookOpen className="w-8 h-8 mx-auto mb-2 text-blue-200" />
                <h3 className="font-baloo text-2xl font-semibold">Building Strong Foundations</h3>
                <p className="font-inter text-sm text-white mt-1">For academic excellence and lifelong learning</p>
              </div> */}
            </div>
          </div>
