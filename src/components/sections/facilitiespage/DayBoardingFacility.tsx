...
const DayBoardingFacility = () => {
  return (
    <section id="day-boarding-facility" className="py-10 my-10 bg-white">
      <div className="container mx-auto px-5 min-[480px]:px-12 sm:px-16 lg:px-20 xl:px-40">
        <div className="flex flex-col md:flex-row-reverse gap-20 items-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-900 mb-12 font-inter text-base sm:text-lg">
        ...
        {/* <div className="bg-blue-900 text-white rounded-xl overflow-hidden">
