        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Empowering Learning Environments</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                <span className="text-emerald-400">World-Class</span> Facilities <br className="hidden sm:block" />
                for Future Leaders
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Our state-of-the-art infrastructure is designed to nurture excellence in academics, sports, and personal development.
              </p>
            </div>
          </div>
        </div>
...
//               World-Class <span className="text-blue-300">Facilities for Future Leaders</span>
//             </h1>
//             <p className="mt-6 mb-12 text-xl text-blue-100">
//               Our state-of-the-art infrastructure is designed to nurture excellence in academics, sports, and personal
//             development.
//             </p>
//           </div>
//         </div>
