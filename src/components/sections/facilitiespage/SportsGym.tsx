...
const SportsGym = () => {
  ...
  return (
    <section id="sports-gym" className="py-10 my-10 bg-white">
          ...
          {facilities.map((facility, index) => (
            <div key={index} className="group relative overflow-hidden rounded-xl shadow-lg h-64">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent flex flex-col justify-end p-5">
                <h3 className="text-white text-xl font-poppins font-semibold tracking-wider mb-1">{facility.name}</h3>
        ...
        <div className="bg-slate-800 text-white rounded-2xl overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 p-8 md:p-14">
              <h3 className="text-2xl md:text-3xl font-poppins font-bold mb-4 tracking-wide">Sports Excellence Program</h3>
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-inter font-semibold mb-1">Professional Coaching</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-inter font-semibold mb-1">Structured Training</h4>
                    <p className="text-blue-100 font-inter">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-inter font-semibold mb-1">Team Building</h4>
                    <p className="text-blue-100 font-inter">
            ...
            <div className="md:w-1/2">
              <div className="relative rounded-xl overflow-hidden shadow-xl">
                <img
                  ...
                  className="w-full"
                />
                {/* <div className="absolute bottom-0 left-0 right-0 bg-blue-900/80 backdrop-blur-sm p-4 md:p-6">
                  <h4 className="text-white font-semibold text-lg">Fitness for All</h4>
                  <p className="text-blue-100 text-sm">
                    Our gymnasium caters to students of all fitness levels with customized programs.
                  </p>
                </div> */}
              </div>
            </div>
