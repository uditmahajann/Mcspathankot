        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Careers @MCS</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Join our team of <span className="text-purple-400">Passionate </span>Educators<br className="hidden sm:block" />
                
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Be part of a vibrant school community where your skills, passion, and dedication help shape the future of our students and our institution.
              </p>
...
// const CareersHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               Join our team<span className="text-blue-300"> of Passionate Educators</span>
//             </h1>
