        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">MCS in News</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                School <span className="text-yellow-400">News & Media</span><br className="hidden sm:block" />
                Highlights
              </h1>
...
// const NewsEventsHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               School <span className="text-blue-300">News & Media Highlights</span>
//             </h1>
