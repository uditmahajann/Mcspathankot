...
const WithdrawalsHero: React.FC = () => {
  return (
        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Our Withdrawal Process</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Get <span className="text-blue-400">Hassle-Free</span><br className="hidden sm:block" />
                Withdrawals 
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Our transparent withdrawal and transfer process ensures all necessary documents and certificates are provided smoothly and on time.
              </p>
...
// const WithdrawalsHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               Withdrawals & Transfer <span className="text-blue-300">Made Hassle-Free</span>
//             </h1>
