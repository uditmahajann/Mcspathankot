          ...
          <div className="max-w-5xl mx-auto text-center mb-12">
              <div className="mx-auto max-w-5xl text-center">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-16">
                  Unleashing Talent <span className="text-blue-300">Through Performing Arts</span>
                </h1>
                <p className="mt-6 mb-12 text-xl text-blue-100">
                  Music, dance, and drama provide our students with a creative outlet to express themselves, build confidence, and celebrate culture.
                </p>
              </div>
