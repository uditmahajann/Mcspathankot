        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Our Syllabus</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                <span className="text-fuchsia-400">Structured </span>Learning <br className="hidden sm:block" />
...
//                   Structured Learning <span className="text-blue-300">with a Clear Roadmap</span>
//                 </h1>
