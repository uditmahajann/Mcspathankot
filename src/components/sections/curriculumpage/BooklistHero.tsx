        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Booklist</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Complete <span className="text-blue-400">Booklist</span> for 2025-26<br className="hidden sm:block" />
              </h1>
...
//                   Your Complete Booklist <span className="text-blue-300">for 2025-26</span>
//                 </h1>
//                 <p className="mt-6 mb-12 text-xl text-blue-100">
//                   Find the prescribed textbooks for each grade, ensuring every student has the resources they need to learn with confidence
//                 </p>
//               </div>
