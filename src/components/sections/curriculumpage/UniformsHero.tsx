        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Our School Uniform</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Uniform for <span className="text-emerald-400">Discipline</span> and Unity<br className="hidden sm:block" />
                
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Our school uniform fosters equality, pride, and discipline while reflecting the values and spirit of MCS Pathankot.
              </p>
...
//                   School Uniform <span className="text-blue-300">for Discipline & Unity</span>
//                 </h1>
