        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Our Curriculum</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                 <span className="text-emerald-400">Academic </span> Calendar of 2025<br className="hidden sm:block" />
              
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                A thoughtfully planned academic year that balances knowledge, creativity, and exploration.
              </p>
...
//                   Our Comprehensive <span className="text-blue-300">Curriculum</span>
//                 </h1>
//                 <p className="mt-6 mb-12 text-xl text-blue-100">
//                   Nurturing minds, building character, and fostering excellence through a holistic educational approach
//                 </p>
//               </div>
