...
const TransferCertificateHero: React.FC = () => {
  return (
        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Transfer Certificate</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Get <span className="text-blue-400">Easy Access</span> to<br className="hidden sm:block" />
                Transfer Certificate
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Details and guidelines for applying and obtaining your child’s Transfer Certificate from MCS Pathankot.
              </p>
...
export default TransferCertificateHero;
...
// const TransferCertificateHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               Easy Access to <span className="text-blue-300">Transfer Certificates</span>
//             </h1>
