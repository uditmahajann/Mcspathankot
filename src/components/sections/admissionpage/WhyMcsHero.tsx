        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Why Choose Us?</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Why <span className="text-blue-400">MCS</span> stands apart?<br className="hidden sm:block" />
                
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Our unique approach combines academic excellence, co-curricular opportunities, discipline, and values – shaping students into achievers and leaders.
              </p>
...
// const AboutHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               Est. {foundingYear} • {yearsOfExcellence} Years of Excellence
//             </span> */}
//             <h1 className="text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-16">
//               Discover Why <span className="text-blue-300">Parents choose MCS</span>
//             </h1>
