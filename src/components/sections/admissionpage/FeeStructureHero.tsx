...
const FeeStructureHero: React.FC = () => {
  return (
        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Our Fee Structure</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Get <span className="text-blue-400">Detailed </span>Fee<br className="hidden sm:block" />
                Structure Breakdown
              </h1>
              <p className="mt-4 text-base sm:text-lg text-white/85">
                Get detailed breakdown of tuition fees, annual charges, and payment schedules to help parents plan confidently.
              </p>
...
// const FeeStructureHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               Get Detailed <span className="text-blue-300">Fee Structure Breakdown</span>
//             </h1>
