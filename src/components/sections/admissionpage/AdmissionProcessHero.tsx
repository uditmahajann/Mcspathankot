        ...
        <div className="relative z-10 w-full">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="max-w-2xl">
              <span className="text-sm tracking-widest uppercase font-semibold text-white/80">Admission At MCS</span>
              <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-poppins font-semibold leading-tight">
                Choosing the <span className="text-emerald-400">Right </span>School Matters<br className="hidden sm:block" />
...
// const AdmissionProcedureHero: React.FC<AboutHeroProps> = ({ schoolName, foundingYear, tagline }) => {
...
//               Admission <span className="text-blue-300">at MCS</span>
//             </h1>
...
// export default AdmissionProcedureHero
