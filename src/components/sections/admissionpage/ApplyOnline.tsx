                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm md:text-base">
                    <div>
                      ...
                      />
                      {formErrors.studentName && <p className="text-sm text-secondary mt-1">{formErrors.studentName}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {formErrors.dob && <p className="text-sm text-secondary mt-1">{formErrors.dob}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      {formErrors.gender && <p className="text-sm text-secondary mt-1">{formErrors.gender}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      {formErrors.applyingForClass && <p className="text-sm text-secondary mt-1">{formErrors.applyingForClass}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      {formErrors.academicYear && <p className="text-sm text-secondary mt-1">{formErrors.academicYear}</p>}
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm md:text-base">
                    <div>
                      ...
                      />
                      {formErrors.parentName && <p className="text-sm text-secondary mt-1">{formErrors.parentName}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {formErrors.email && <p className="text-sm text-secondary mt-1">{formErrors.email}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {formErrors.phone && <p className="text-sm text-secondary mt-1">{formErrors.phone}</p>}
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      ></textarea>
                      {formErrors.address && <p className="text-sm text-secondary mt-1">{formErrors.address}</p>}
                    </div>
              ...
              {formStep === 3 && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg text-sm md:text-base">
                    ...
                    <h4 className="font-inter font-semibold text-xl text-primarydark mb-6">Parent/Guardian Information</h4>
